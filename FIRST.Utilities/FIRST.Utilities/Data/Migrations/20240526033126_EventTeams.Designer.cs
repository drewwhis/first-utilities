...
namespace FIRST.Utilities.Migrations
{
    ...
    [Migration("20240526033126_EventTeams")]
            ...
            modelBuilder.Entity("FIRST.Utilities.Models.Database.Event", b =>
                {
                    ...
                    b.HasIndex(new[] { "ProgramCode", "EventCode", "SeasonYear" }, "Event_Identification")
                        .IsUnique();

                    b.ToTable("Events");
                });

            modelBuilder.Entity("FIRST.Utilities.Models.Database.EventTeam", b =>
                {
                    ...
                    b.HasIndex(new[] { "EventId", "TeamId" }, "Team_Registration")
                        .IsUnique();

                    b.ToTable("EventTeams");
                });

            modelBuilder.Entity("FIRST.Utilities.Models.Database.Program", b =>
                {
                    b.Property<int>("ProgramId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<int>("ActiveSeasonYear")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("FIRST.Utilities.Models.Database.EventTeam", b =>
                {
                    ...
                    b.HasOne("FIRST.Utilities.Models.Database.Team", "Team")
                        .WithMany("EventTeams")
